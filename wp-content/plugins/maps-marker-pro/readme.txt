...
* search for locations by using keyless geocoding providers like Algolia Places (optional: use the geocoding providers MapQuest Geocoding, LocationIQ, tomtom or Google Places with mandatory API key registration),
...
* Turkish (tr_TR) thanks to Emre Erkan, Mahir Tosun and Cagatay Demir
...
== Upgrade Notice ==
= 4.16.2 =
See [https://www.mapsmarker.com/v4.16.2](https://www.mapsmarker.com/v4.16.2) for more details - if you experience any issues, please [open a support ticket at https://www.mapsmarker.com/helpdesk/](https://www.mapsmarker.com/helpdesk/).

== Changelog ==
= 4.16.2 =
translation updates and minor fixes - see [https://www.mapsmarker.com/v4.16.2](https://www.mapsmarker.com/v4.16.2) for more details

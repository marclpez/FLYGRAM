...
class DB {
	...
	private function parse_marker_filters($filters, $group = true) {
		...
		if (isset($filters['scheduled']) && $filters['scheduled'] === false) {
			$query .= " AND (markers.schedule_from IS NULL OR markers.schedule_from = '0000-00-00 00:00:00' OR markers.schedule_from <= NOW()) AND (markers.schedule_until IS NULL OR markers.schedule_until = '0000-00-00 00:00:00' OR markers.schedule_until >= NOW())";
		}
		if ($group) {

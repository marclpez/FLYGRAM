                ...
                <div class="col">
                    ...
                    <?php if( bpbm_fs()->is_premium() && ! bpbm_fs()->can_use_premium_code() ){ ?>
                        <div class="bp-better-messages-connection-check bpbm-error">
                            <p>This website using WebSocket plugin version, but has no activate license attached.</p>
                            <p>If you have license and it must be attached to this website, try to press sync button in <a href="<?php echo admin_url('admin.php?page=bp-better-messages-account'); ?>">your account</a>.</p>
                        </div>
                    <?php } else if( bpbm_fs()->can_use_premium_code() ){
                    if( ! class_exists('BP_Better_Messages_Premium') ) {  ?>
                        <div class="bp-better-messages-connection-check bpbm-error">
                            <p>Seems like this website has active WebSocket License, but you are still using free version of plugin. Try to download and install plugin from <a href="<?php echo admin_url('admin.php?page=bp-better-messages-account'); ?>">your account</a> page.</p>
                        </div>
                    <?php
                    } else { ?>
                        <div class="bp-better-messages-connection-check">
                            <p>This website has domain name <b><?php echo BP_Better_Messages_Premium()->site_id; ?></b></p>
                            <p class="bpbm-checking-sync"><span class="dashicons dashicons-update-alt" style="animation:bpbm-spin 4s linear infinite;"></span> Double-checking if WebSocket server know about this domain and sync is fine</p>
                        </div>
                        <script type="text/javascript">
                            jQuery(document).ready(function($){
                                var checking = $('.bpbm-checking-sync');
                                $.post('https://bpbettermessages.com/license/checksync.php', {
                                    ...
                                    if( response ){
                                        ...
                                        checking.html('<span class="dashicons dashicons-yes-alt"></span> All good, WebSocket server know about this domain, all should be working good.');
                                    } else {
                                        checking.parent().addClass('bpbm-error');
                                        checking.html('<span class="dashicons dashicons-dismiss"></span> Oh no, WebSocket server dont know about this domain, realtime functionality will not work. If you just activated the license at this website wait 5-15 mins and check it again.');
                                    }
                                });
                            });
                        </script>
        ...
        <div id="calls" class="bpbm-tab">
            ...
            <table class="form-table">
                ...
                <tr valign="top" class="">
                    ...
                    <td>
                        <input name="callsRevertIcons" type="checkbox" <?php checked( $this->settings[ 'callsRevertIcons' ], '1' ); ?> value="1" <?php  if( ! bpbm_fs()->can_use_premium_code() ) echo 'disabled'; ?> />
                        <?php if( ! bpbm_fs()->can_use_premium_code() ) { ?>
                            <a style="font-size: 10px;" href="<?php echo admin_url('admin.php?page=bp-better-messages-pricing'); ?>">Get WebSocket License</a>
                        <?php } ?>
                    </td>
                ...
                <tr valign="top" class="">
                    ...
                    <td>
                        <fieldset>
                            ...
                            <label>
                            <input type="number" name="callRequestTimeLimit" value="<?php echo esc_attr( $this->settings[ 'callRequestTimeLimit' ] ); ?>" <?php if( ! bpbm_fs()->can_use_premium_code() ) echo 'disabled'; ?>>
                            </label>
                            <?php if( ! bpbm_fs()->can_use_premium_code() ) { ?>
                                <a style="font-size: 10px;" href="<?php echo admin_url('admin.php?page=bp-better-messages-pricing'); ?>">Get WebSocket License</a>
                            <?php } ?>
                ...
                <tr valign="top" class="">
                    ...
                    <td>
                        <input name="offlineCallsNotifications" type="checkbox" <?php checked( $this->settings[ 'offlineCallsNotifications' ], '1' ); ?> value="1" <?php if( ! bpbm_fs()->can_use_premium_code() ) echo 'disabled'; ?> />
                        <?php if( ! bpbm_fs()->can_use_premium_code() ) { ?>
                            <a style="font-size: 10px;" href="<?php echo admin_url('admin.php?page=bp-better-messages-pricing'); ?>">Get WebSocket License</a>
                        <?php } ?>
                    </td>
                ...
                <tr valign="top" class="">
                    ...
                    <td>
                        <input name="callsLimitFriends" type="checkbox" <?php disabled( ! function_exists('friends_get_friend_user_ids') ); ?> <?php checked( $this->settings[ 'callsLimitFriends' ], '1' ); ?> value="1" <?php  if( ! bpbm_fs()->can_use_premium_code() ) echo 'disabled'; ?> />
                        <?php if( ! bpbm_fs()->can_use_premium_code() ) { ?>
                            <a style="font-size: 10px;" href="<?php echo admin_url('admin.php?page=bp-better-messages-pricing'); ?>">Get WebSocket License</a>
                        <?php } ?>
                    </td>

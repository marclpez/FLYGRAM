<div class="bp-messages-wrap bp-messages-wrap-main">
    <div class="chat-header">
        <a href="<?php echo BP_Better_Messages()->functions->get_link(); ?>" class="new-message ajax" title="<?php _e( 'Close', 'bp-better-messages' ); ?>"><i class="fas fa-times" aria-hidden="true"></i></a>

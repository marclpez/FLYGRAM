<?php
/**
 * Template Loader for Plugins. Changed name from Gamajo_Template_Loader to GpsPlotter_Gamajo_Template_Loader
 ...
 *
 */
class GpsPlotter_Gamajo_Template_Loader {
	 ...
	 * @since 1.0.0
	 *
	 * @uses GpsPlotter_Gamajo_Template_Loader::get_template_possble_parts() Create file names of templates.
	 * @uses GpsPlotter_Gamajo_Template_Loader::locate_template() Retrieve the name of the highest priority template
	 *     file that exists.
	 *
	 * @param string  $slug
	 ...
	 * @since 1.0.0
	 *
	 * @uses GpsPlotter_Gamajo_Tech_Loader::get_template_paths() Return a list of paths to check for template locations.
	 *

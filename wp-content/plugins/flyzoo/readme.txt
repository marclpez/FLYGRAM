=== Flyzoo Chat ===
Contributors: Flyzoo
Tags: buddypress, community, chat, chat room, group chat, embed chat, live chat
...
Add chat to your website in 5 minutes! Perfectly integrated with the most popular membership and social network plugins.

Flyzoo Chat provides all you need to build a thriving community.
...
Need more time to get started? Open a [Support Ticket >>](https://www.flyzoo.co/support), and we'll extend your trial.
...
- NEW: Added the Korean language

06.29.2017

- NEW: Added the Romanian language
...
- Ignore user 
- Require guests to change name before accessing a group chat
- File sharing

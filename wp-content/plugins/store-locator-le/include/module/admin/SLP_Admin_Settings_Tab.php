...
class SLP_Admin_Settings_Tab extends SLP_Object_With_Objects {
	...
	private function save_the_country() {
		$selected_country                    = SLP_Country_Manager::get_instance()->countries[ $_POST['options_nojs']['default_country'] ];
		...
		//
		if ( $_POST['options_nojs']['default_country'] !== SLP_SmartOptions::get_instance()->default_country->value ) {
			SLP_SmartOptions::get_instance()->set( 'default_country' , $_POST['options_nojs']['default_country']);
		}

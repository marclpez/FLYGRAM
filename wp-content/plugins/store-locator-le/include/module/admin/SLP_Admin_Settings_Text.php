...
class SLP_Admin_Settings_Text extends SLPlus_BaseClass_Object {
	...
	private function set_text_strings() {
		...
		$this->text_strings['settings_section']['tools']   = __( 'Tools', 'store-locator-le' );
		...
		$this->text_strings['label']['default_country']       = __( 'Map Domain', 'store-locator-le' );
		$this->text_strings['description']['default_country'] = __( 'Select the Google maps API url to be used by default for location queries. ', 'store-locator-le' );

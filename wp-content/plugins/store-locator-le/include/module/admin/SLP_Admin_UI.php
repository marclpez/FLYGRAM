...
class SLP_Admin_UI extends SLP_BaseClass_Admin {
	...
	public function enqueue_block_editor_assets() {
		wp_enqueue_style( 'store-locator-plus-block' , plugins_url( 'css/slp-blocks.css', SLP_LOADER_FILE ) , array(), filemtime( SLPLUS_PLUGINDIR . 'css/slp-blocks.css' )  );

		wp_register_script( 'store-locator-plus-block', plugins_url( 'js/slp-blocks.js', SLP_LOADER_FILE ), array( 'wp-blocks', 'wp-editor', 'wp-element', 'wp-i18n' ), filemtime( SLPLUS_PLUGINDIR . 'js/slp-blocks.js' ));
		...
		wp_localize_script( 'store-locator-plus-block' , 'slplus' , $script_data );

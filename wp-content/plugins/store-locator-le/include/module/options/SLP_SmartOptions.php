...
BUBBLELAYOUT
            ...
            $this->create_smart_options( $smart_options , array( 'page' => 'slp_experience' , 'section' => 'map' , 'group' => 'appearance', 'classes' => array( 'quick_save' ) ) );
        }
        ...
        private function experience_map_functionality() {
            ...
            $this->create_smart_options( $smart_options , array( 'page' => 'slp_experience' , 'section' => 'map' , 'group' => 'functionality', 'classes' => array( 'quick_save' ) ) );
        }
        ...
        private function experience_map_markers() {
            ...
            $this->create_smart_options( $smart_options , array( 'page' => 'slp_experience' , 'section' => 'map' , 'group' => 'markers', 'classes' => array( 'quick_save' ) ) );
        }
        ...
        private function experience_results_at_startup() {
            ...
            $this->create_smart_options( $smart_options , array( 'page' => 'slp_experience' , 'section' => 'results' , 'group' => 'at_startup', 'classes' => array( 'quick_save' ) ) );
        }
        ...
        private function experience_results_after_search() {
            ...
            $this->create_smart_options( $smart_options , array( 'page' => 'slp_experience' , 'section' => 'results' , 'group' => 'after_search', 'classes' => array( 'quick_save' ) ) );
        }
...
RESULTSLAYOUT
	        ...
	        $this->create_smart_options( $smart_options, array( 'page' => 'slp_experience', 'section' => 'results', 'group' => 'appearance', 'classes' => array( 'quick_save' ) ) );
        }
        ...
        private function results_appearance_no_results() {
	        ...
	        $this->create_smart_options( $smart_options , array( 'page' => 'slp_experience' , 'section' => 'results' , 'group' => 'appearance_no_results', 'classes' => array( 'quick_save' ) ) );
        ...
        private function experience_results_labels() {
            ...
            $this->create_smart_options( $smart_options , array( 'page' => 'slp_experience' , 'section' => 'results' , 'group' => 'labels', 'classes' => array( 'quick_save' ) ) );
        }
...
SEARCHLAYOUT
            ...
            $this->create_smart_options( $smart_options , array( 'page' => 'slp_experience' , 'section' => 'search' , 'group' => 'appearance', 'classes' => array( 'quick_save' ) ) );
        }
        ...
        private function experience_search_functionality() {
            ...
            $this->create_smart_options( $smart_options , array( 'page' => 'slp_experience' , 'section' => 'search' , 'group' => 'functionality', 'classes' => array( 'quick_save' ) ) );
        }
        ...
        private function experience_search_labels() {
            $smart_options['label_radius'] = array(
                'is_text' => true,
                'related_to' => 'label_radius,first_entry_for_radius_selector'
            );
            $smart_options['label_search'] = array(
                'is_text'    => true,
                'related_to' => 'address_placeholder,label_search,hide_address_entry',
            );
            $this->create_smart_options( $smart_options , array( 'page' => 'slp_experience' , 'section' => 'search' , 'group' => 'labels', 'classes' => array( 'quick_save' ) ) );
        }
        ...
        private function view_appearance() {
	        ...
	        $this->create_smart_options( $smart_options , array( 'page' => 'slp_experience' , 'section' => 'view' , 'group' => 'appearance', 'classes' => array( 'quick_save' ) ) );
		}
        ...
        private function general_admin_addons() {
	        ...
	        $this->create_smart_options( $smart_options , array( 'page' => 'slp_general' , 'section' => 'admin' , 'group' => 'add_on_packs', 'classes' => array( 'quick_save' ) ) );
        }
        ...
        private function general_admin_messages() {
            ...
            $this->create_smart_options( $smart_options , array( 'page' => 'slp_general' , 'section' => 'admin' , 'group' => 'messages', 'classes' => array( 'quick_save' ) ) );
        }
        ...
        private function general_app_map_services() {
	        ...
	        $this->create_smart_options( $smart_options , array( 'page' => 'slp_general' , 'section' => 'server' , 'group' => 'map_services', 'classes' => array( 'quick_save' ) ) );
        }
		...
		private function general_app_features() {
			...
			$this->create_smart_options( $new_options , array( 'page'=> 'slp_general','section' => 'server', 'group' => 'web_app_settings', 'classes'    => array( 'quick_save' ) ) );
		}
        ...
        private function general_user_interface() {
	        ...
	        $this->create_smart_options( $new_options , array( 'page' => 'slp_general' , 'section' => 'user_interface' , 'group' => 'url_control', 'classes' => array( 'quick_save' ) ) );
        }
		...
		public function set( $property, $value ) {
			if ( property_exists( $this, $property ) ) {
				...
				if ( $this->$property->use_in_javascript ) {
					return $this->set_valid_options( $value, $property );
				} else {
					return $this->set_valid_options_nojs( $value, $property );
				}
			}
		...
		private function set_valid_option( $val, $key, $which_option ) {
			...
			if ( $is_smart_option ) {
				...
				if ( ! $valid_legacy_option ) return false;
			}

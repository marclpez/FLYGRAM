...
if ( ! class_exists( 'SLPlus' ) ) {
	...
	class SLPlus extends SLP_Object_With_Objects {
		...
		public function initialize() {
			...
			$this->Helper = SLP_Admin_Helper::get_instance();
		...
		public function enqueue_google_maps_script() {
			if ( empty( $this->SmartOptions->google_server_key->value ) ) return;
		...
		/**
		 * True if on a test domain.
		 *
		 * @return boolean
		 */
		public function is_test() {
			return preg_match( '/\.test$/' , get_home_url() );
		}

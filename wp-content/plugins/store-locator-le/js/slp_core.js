 ...
 *
 * Expects slp and slp_Filter to be defined objects before this is loaded.
 *
 * @version 5.6
 *
...
slp = {
	 ...
	 * @returns {string}
	 */
	shortcode_output: function ( currentLocation, field_name, value , modifier, modarg, modifier2, modarg2 ) {
		var output;

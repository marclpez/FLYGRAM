  ...
  iflyLazyLoad.js([iflychat_bundle.src], function() {
    jQuery(document).ready(function($) {
      ...
      if(typeof iflychat_auth_url!=="undefined") {
        ...
        jQuery.getScript(iflychat_bundle.src, function(response) {
          iflychat_load_cc_init({});
        });
      }
    });
...
function iflychat_load_cc_init(user) {
  // Initialize ChatCamp

...
As of January 2020, the free version of the Maps Marker plugin has earned its retirement: It will still be usable, but it we will only add occasional security updates, no new features and bugfixes. Our recommendation is to upgrade to Maps Marker Pro - read more in our sticky forum post & retirement FAQ at https://wordpress.org/support/topic/were-retiring-the-free-version/
...
== Changelog ==
Leaflet Maps Marker has earned its retirement - existing users get a parting gift: a 50% coupon code for an unexpiring Maps Marker Pro license - see [https://www.mapsmarker.com/v3.12.4](https://www.mapsmarker.com/v3.12.4) for more details

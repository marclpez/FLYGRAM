...
<?php
/*****************************************************************************************/
echo '<p style="margin:0.5em 0 0 0;clear:both;"><strong>' . sprintf($text_a, '3.12.4') . '</strong> - ' . $text_b . ' 13.02.2021 (<a href="https://www.mapsmarker.com/v3.12.4" target="_blank">' . $text_c . '</a>):</p>
<table>
<tr><td>' . $new . '</td><td>
...
<tr><td>' . $fixed . '</td><td>
fix basic compatibility with PHP8
</td></tr>
</table>'.PHP_EOL;

if ( (version_compare($lmm_version_old,"3.12.3","<")) && ( $lmm_version_old > '0' ) ) {
